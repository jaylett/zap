...
<p>You may not sell the program without written permission. However, Public Domain libraries may distribute the program, provided that they charge at most &pound;3 sterling per disc. If anyone else would like to distribute Zap, then please get in touch beforehand in order to obtain permission to do so.</p>

<p>'Zap developers' include:</p>
...
<li>Daniel Wagenaar (original softwrap code)
<li>Elliot Hughes (WC code)
</ul>
